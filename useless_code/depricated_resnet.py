...
# #
# #
# # def ResNet50(num_classes, channels=3, pretrained=True):
# #     model = ResNet(Bottleneck, [3, 4, 6, 3], num_classes, channels)
# #     if pretrained:
# #         weights = load_state_dict_from_url('https://download.pytorch.org/models/resnet50-19c8e357.pth')
